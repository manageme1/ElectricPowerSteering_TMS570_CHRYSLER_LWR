 ...
 *
 *  Description:       Initialization routine for the MyCompany MEC.
 *
 *  Inputs:            None
 *
 *  Outputs:           None
 ...
 *
 *  Description:       Main entry point for all MyCompany common manufacturing services
 *
                                                         ...
                                                         P2VAR(CM_MsgLenType, EPSDIAGSRVC_VAR, EPSDIAGSRVC_VAR) RespLen_Cnt_T_u16)
{
    ...
    if (t_DiagSrv_PIDtbl[LUTidx_Uls_T_u16].active == TRUE)
    {
        ...
        {
            /*** Not in MyCompany Mode ***/
            if (NxtrMEC_Uls_G_enum == ProductionMode)
            {
                /* Switch NRC for production mode - effectively "hiding" our services outside of MyCompany Session.
 ...
 *                     MyCompany defined NRC in the CM spec
 *
 ...
 *    Configured NRCs: N/A
 *
 *    Description:     MyCompany ECU Reset
 *
 *    Inputs:          SubFunc_Cnt_T_u08    : Sub-function type - varies based on srvc type - see MainHandler function
        ...
        switch (SubFunc_Cnt_T_u08)
        {
            case D_EPSRIDSUBSTART_CNT_U08:
                ...
                if(CmdResp_Cnt_T_u08 == D_EPSNRCNOERROR_CNT_U08)
                {
                    ...
                    /* Set clear var to clear defeat bits on session change out of MyCompany session */
 ...
 *    Configured NRCs: MEC Counter Equals Zero (0xFB)
 *
 *    Description:     MyCompany CCP/XCP Transmit and Receive IDs
 *
 *    Inputs:          SubFunc_Cnt_T_u08    : Sub-function type - varies based on srvc type - see MainHandler function
 *                     DataBuffer_Uls_T_u08 : Buffer for request/response data
 *                     RequestLen_Cnt_T_u16 : Number of byte of request data in buffer when function is called
 ...
 *    Configured NRCs: N/A
 *
 *    Description:     Read MyCompany DTCs
 *
 *    Inputs:          SubFunc_Cnt_T_u08    : Sub-function type - varies based on srvc type - see MainHandler function
 *                     DataBuffer_Uls_T_u08 : Buffer for request/response data
 *                     RequestLen_Cnt_T_u16 : Number of byte of request data in buffer when function is called
 ...
 *    Configured NRCs: MEC Counter Equals Zero (0xFB)
 *
 *    Description:     MyCompany Manufacturing Scratchpad
 *
 *    Inputs:          SubFunc_Cnt_T_u08    : Sub-function type - varies based on srvc type - see MainHandler function
 *                     DataBuffer_Uls_T_u08 : Buffer for request/response data
 *                     RequestLen_Cnt_T_u16 : Number of byte of request data in buffer when function is called
