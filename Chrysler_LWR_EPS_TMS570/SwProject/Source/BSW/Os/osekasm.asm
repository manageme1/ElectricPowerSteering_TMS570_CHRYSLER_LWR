...
osRef_:rname:    .word  :rname:
 .endm
  ...
  osExtRef _dabort			;MyCompany edit for anomaly 3032
  osExtRef _pabort		;MyCompany edit for anomaly 3032
...
osPrefetchAbort:
  ...
  ldmfd  sp!,{r0, r1}          ; pop r0, r1
  b      _pabort  ; NEXTEER EDIT: goto MyCompany Prefetch Abort Handler 
...
; TR:SPMF89:01.0093 Start
  ...
  ; no MPU fault, jump to application abort handler
  ldmfd  sp!,{r0, r1}          ; pop r0, r1
  b      _dabort  ; NEXTEER EDIT: goto MyCompany Prefetch Abort Handler 
