 ...
 * 				2) Start the MyCompany "Operation Cycle" by updating appropriate bits
 ...
 *              restarts the MyCompany "Operation Cycle" in the case in the case that "OFF" state is exited
