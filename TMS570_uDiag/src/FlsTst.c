...
/* MyCompany extension include for DMA MPU Error notification */
#include "uDiag.h"
...
FUNC(void, FLSTST_CODE) FlsTst_Init( const FlsTst_ConfigType* ConfigPtr )
{
	...
	/* Perform the Hardware Self Test when configured. This Self Test concept is a MyCompany extension to the driver specified by AUTOSAR */
