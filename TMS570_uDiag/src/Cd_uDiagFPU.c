/*****************************************************************************
* Copyright 2011 MyCompany Automotive, All Rights Reserved.
...
/*****************************************************************************
  * Name:        Mcu_FpuIrq
  * Description: MyCompany extension to the AUTOSAR specification.  Handles FPU failures detected by VFP peripheral
  * Inputs:      None
  * Outputs:     None
  *
*****************************************************************************/
